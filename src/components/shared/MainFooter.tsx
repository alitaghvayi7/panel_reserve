...
const MainFooter = () => {
  return (
    <div className="w-full bg-primary-gray flex flex-col lg:flex-row items-stretch lg:items-start lg:justify-start px-6 lg:px-36 py-8 lg:py-10 gap-7 lg:gap-24 mt-auto">
      <div className="flex flex-col xl:flex-row items-center xl:items-start gap-5">
        ...
        <div className="flex flex-col items-stretch gap-3 justify-center">
          ...
          <p className="lg:max-w-[260px] text-[12px] lg:text-[14px] font-light text-secendory-black leading-4 lg:leading-5">
            ...
            ،نایب رئیس مجلس دهم و نماینده شجاع مردم شریف تبریز، آذرشهر و اسکو در
